...
const classes: OurClassType[] = [
    {
      ...
      {
        name: "Yoga Classes",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum magnam nesciunt cum molestias quis, voluptas doloribus cumque reiciendis exercitationem distinctio.",
        image: image2,
      },
      {
      ...
      },
      {
        ...
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente asperiores, cum dolore quae placeat nisi? Aliquam recusandae neque ad ipsam!",
        image: image5,
      },
      {
            ...
            <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.OurClasses)}>
                ...
                <div className="mt-10 w-full h-[353px] overflow-x-auto overflow-y-hidden">
                    <ul className="w-[2800px] whitespace-nowrap">
                        {classes.map((i: OurClassType,index: number) => <OurClass key={`${i.name}-${index}`} ourClass={i} />)}
                    </ul>
                </div>
            </motion.div>
        </section>
